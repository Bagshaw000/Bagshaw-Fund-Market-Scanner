...
SCHEMA_PATH = Path('C:/Users/hp/Documents/Documents/GitHub/Bagshaw-Fund-Market-Scanner/backend/.venv/prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    day: 'actions.dayActions[models.day]'
    month: 'actions.monthActions[models.month]'
    ...
    def __init__(
        ...
        *,
        ...
        self.day = actions.dayActions[models.day](self, models.day)
        self.month = actions.monthActions[models.month](self, models.month)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/hp/Documents/Documents/GitHub/Bagshaw-Fund-Market-Scanner/backend/.venv/prisma/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.day = dayBatchActions(self)
        self.month = monthBatchActions(self)
